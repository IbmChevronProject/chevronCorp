...
{
    public static class getServiceLineName
    {
        [FunctionName("getServiceLineName")]
            ...
            ILogger log)
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    var query = $"SELECT ServiceLineName FROM  [ServiceLine] where ServiceLineId='{serviceLineId}'";
