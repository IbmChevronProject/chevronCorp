            ...
            ILogger log)
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    var query = $"select InterviewId,InterviewName,FORMAT (FromDate, 'dd/MM/yyyy ') as FromDate ,FORMAT (ToDate, 'dd/MM/yyyy ') as ToDate,a.SkillId,SkillName from InterviewDetails a inner join Skills b on a.SkillId=b.SkillId where Fromdate >getdate() and a.ServiceLineId ='{serviceLineId}'";
