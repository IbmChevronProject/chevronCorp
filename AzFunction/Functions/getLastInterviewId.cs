...
{
    public static class getLastInterviewId
    {
        [FunctionName("getLastInterviewId")]
            ...
            ILogger log)
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    var query = $"Select top 1 InterviewId from InterviewDetails order by InterviewId desc";
