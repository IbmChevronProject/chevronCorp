            ...
            ILogger log)
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    var query = $"SELECT [SkillId],[SkillName],ServiceLineName  FROM [Skills] a INNER JOIN [ServiceLine] b on a.ServiceLineId = b.ServiceLineId and a.ServiceLineId='{serviceLineId}'";
